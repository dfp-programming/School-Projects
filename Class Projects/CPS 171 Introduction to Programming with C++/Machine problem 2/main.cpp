...
in a another text file called mp2accept.txt. At the same time, this program will echo the information for each applicant and will print in the console if they were accepted or not, and the reason for rejection. 
...
int main() {
	...
	while(!readFromFile.eof()){
		...
		if((school=='L')&&(alumnus=='N')&&(gpa>=3.5)&&(verbalSat+mathSat)>=1200&&(liberalCount<5)){
			...
			writeToFile << ' ' << school << ' ' <<  showpoint << setprecision(2) << gpa << ' ' << mathSat << ' ' << verbalSat << ' ' << alumnus << endl; //writing the applicant's info into the file
			
			//Output a message with the applicants info and acceptance into Liberal Arts school. Also adding one to the acceptance count
			++liberalCount;
			cout << "Applicant #: " << totalCount <<endl;
			cout << "School = " << school << " GPA = "  << showpoint << setprecision(2) << gpa <<" math = " << setprecision(0) << mathSat << " verbal = " << verbalSat << " alumnus = " << alumnus << endl;
		...
		//This screens applicants who's parents attended liberal arts school and have the right scores. Only the first five will get in.
				...
				writeToFile << ' ' << school << ' ' <<  showpoint << setprecision(2) << gpa << ' ' << mathSat << ' ' << verbalSat << ' ' << alumnus << endl; //writing the applicant's info into the acceptance file
					
				//Output a message with the applicants info and acceptance into Liberal Arts school.  Also adding one to the acceptance count
				++liberalCount;
				cout << "Applicant #: " << totalCount <<endl;
				cout << "School = " << school << " GPA = " << showpoint << setprecision(2) << gpa <<" math = " << mathSat << " verbal = " << verbalSat << " alumnus = " << alumnus << endl;
				cout << "Applying to Liberal Arts" << endl;
				cout << "Accepted to Liberal Arts!! " << endl;
				cout << "*******************************\n" << endl;
			}
		...
		else if ((school=='M')&&(verbalSat>=500)&&(musicCount<3)){
			
					writeToFile << ' ' << school << ' ' <<  showpoint << setprecision(2) << gpa << ' ' << mathSat << ' ' << verbalSat << ' ' << alumnus << endl; //writing the applicant's info into the acceptacnce file
				
					//Output a message with the applicants info and acceptance into Music school.  Also adding one to the acceptance count
					++musicCount;
					cout << "Applicant #: " << totalCount <<endl;
					cout << "School = " << school << " GPA = " << showpoint << setprecision(2) << gpa <<" math = " << mathSat << " verbal = " << verbalSat << " alumnus = " << alumnus << endl;
		...
		// The next set of  statements will print to console messsages with the applicant's info that didn't get into school, and will state why. 
		else{
			cout << "Applicant #: " << totalCount <<endl;
			cout << "School = " << school << " GPA = " << showpoint << setprecision(2) << gpa <<" math = " << mathSat << " verbal = " << verbalSat << " alumnus = " << alumnus << endl;
			...
			if(school=='L'){
				...
				if(alumnus=='Y'){
					...
					if (gpa<3.0){
						...
						cout<< "Rejected - "<< "SAT too low" << endl;
						cout << "*******************************\n" << endl;
						}
					else if(liberalCount>=5){
						cout << "Rejected - " << "The school is full" << endl;
						cout << "*******************************\n" << endl;
						}
					}
...
//Print to console the total applicant and acceptance count	for each school to summarize the entire process.
cout << "There were " << setw(2) << setfill('0') << totalCount << " applicants in the file"<< endl; 
cout << "There were " << setw(2) << liberalCount << " acceptances to Liberal Arts"<< endl;
cout << "There were " << setw(2) << musicCount << " acceptances to Music"<< setfill(' ') << endl;
